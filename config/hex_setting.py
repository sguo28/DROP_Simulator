...
N_DQN_VEHICLES = int(500)
DEMAND_SCALE=0.1 #0.1 for high demand and 0.08 for low demand
MAX_WAIT_TIME=300 #use 600 for undersupply and 300 for oversupply
MAX_MATCH_TIME=9999999 #use 480
...
N_EPISODE=int(14) # number of episode
