...
class Vehicle(object):
    ...
    def dump_transitions(self):
        exported_trans = []
        if len(self.recent_transitions) > 1:
    ...
    def send_to_dispatching_pool(self, converted_action_id,opts):
        self.state.dispatch_action_id = converted_action_id
    ...
    def pickup(self):
        ...
        self.assigned_option=-1 #no longer follow options
